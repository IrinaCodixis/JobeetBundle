...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
  public function load(ObjectManager $em)
  {
	...
	$job_sensio_labs->setCreatedAt(new \DateTime('2015-08-20'));
  //$job_sensio_labs->setExpiresAt(new \DateTime('2015-09-19'));
   ...
   // $job_extreme_sensio->setExpiresAt(new \DateTime('2015-09-10'));
	$job_extreme_sensio->setCreatedAt(new \DateTime('2015-08-24'));
